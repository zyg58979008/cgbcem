...
public class MenuServiceImpl implements MenuService {
	...
	public Tree<MenuDO> getSysMenuTree(Long id) {
		...
		Tree<MenuDO> t = BuildTree.build(trees,null);
		return t;
	}
	...
	@Override
	public List<Tree<MenuDO>> listMenuTreeMobile(Long id) {
		List<Tree<MenuDO>> trees = new ArrayList<Tree<MenuDO>>();
		List<MenuDO> menuDOs = menuMapper.listMenuByUserIdMobile(id);
		for (MenuDO sysMenuDO : menuDOs) {
			Tree<MenuDO> tree = new Tree<MenuDO>();
			tree.setId(sysMenuDO.getMenuId().toString());
			tree.setParentId(sysMenuDO.getParentId().toString());
...
//查询区域级别
	@Override
	public String area_level(Long deptId) {
		return menuMapper.area_level(deptId);
	}
