...
function reLoad() {
	...
	a.push({
		'field' : 'contractStartDateString', // 列字段名
		'title' : '合同起',
		'rowspan': 2//标题  可不加
	});
	a.push({
		'field' : 'contractEndDateString', // 列字段名
		'title' : '合同止',
		'rowspan': 2//标题  可不加
	});

	a.push({
		'field' : 'contractPayTotal', // 列字段名
		'title' : '合同应收总计',
		'rowspan': 2//标题  可不加
	});
	a.push({
		'field' : 'contractPayTotalReceived', // 列字段名
		'title' : '合同已收总计',
		'rowspan': 2//标题  可不加
	});
...
for(var x =1;x<=i;x++){
	...
	b.push({
		field: 'fenleiZujin'+x,
		title: '租金(应收)', align: "center"}
	);
	b.push({
		field: 'fenleiWuye'+x,
		title: '物业费(应收)', align: "center"}
	);
	b.push({
		field: 'fenleiGuanli'+x,
		title: '管理费(应收)', align: "center"}
	);
	b.push({
		field: 'fenleiZujinReceived'+x,
		title: '租金(已收)', align: "center"
	});
	b.push({
		field: 'fenleiWuyeReceived'+x,
		title: '物业费(已收)', align: "center"
	});
	b.push({
		field: 'fenleiGuanliReceived'+x,
		title: '管理费(已收)', align: "center"
	});
	b.push({
		field: 'fenleiZujinUnreceived'+x,
		title: '租金(差额)', align: "center"
	});
	b.push({
		field: 'fenleiWuyeUnreceived'+x,
		title: '物业费(差额)', align: "center"
	});
	b.push({
		field: 'fenleiGuanliUnreceived'+x,
		title: '管理费(差额)', align: "center"
	});
	b.push({
		field: 'startDate'+x,
		title: '计费起', align: "center"
	});
	b.push({
		field: 'endDate'+x,
		title: '计费止', align: "center"
	});
	...
	if(x==i){
		a.push({
			title: yearS+'年'+monthS+'月份之前商户欠缴总额',
			colspan: 9, align: "center"
		});
		b.push({
			field: 'fenleiZujinPart',
			title: '租金(应收)', align: "center"}
		);
		b.push({
			field: 'fenleiZujinReceivedPart',
			title: '租金(已收)', align: "center"
		});
		b.push({
			field: 'fenleiZujinUnreceivedPart',
			title: '租金(差额)', align: "center"
		});
		b.push({
			field: 'fenleiGuanliPart',
			title: '管理费(应收)', align: "center"}
		);
		b.push({
			field: 'fenleiGuanliReceivedPart',
			title: '管理费(已收)', align: "center"
		});
		b.push({
			field: 'fenleiGuanliUnreceivedPart',
			title: '管理费(差额)', align: "center"
		});
		b.push({
			field: 'fenleiWuyePart',
			title: '物业费(应收)', align: "center"}
		);
		b.push({
			field: 'fenleiWuyeReceivedPart',
			title: '物业费(已收)', align: "center"
		});
		b.push({
			field: 'fenleiWuyeUnreceivedPart',
			title: '物业费(差额)', align: "center"
		});/*
	...
	if(monthS>12){
     ...
     {
     url : prefix + "/shopContractTypeList",
		 fixedColumns: true,
		 fixedNumber:4,
