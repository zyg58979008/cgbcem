...
for(var x =1;x<=i;x++){
    ...
    b.push({
        field: 'contractPayTotal'+x,
        title: '应收款', align: "center"}
    );
    b.push({
            field: 'contractPayTotalReceived'+x,
            title: '已收款', align: "center"
        });
    b.push({
        field: 'contractPayTotalUnreceived'+x,
        title: '差额', align: "center"
    });
	b.push({
		field: 'startDate'+x,
	...
	if(x==i){
		...
		b.push({
			field: 'contractPayTotalPart',
			title: '应收款', align: "center"}
		);
		b.push({
			field: 'contractPayTotalReceivedPart',
			title: '已收款', align: "center"
		});
		b.push({
			field: 'contractPayTotalUnreceivedPart',
			title: '差额', align: "center"
		});/*
