                ...
                columns: [
                    [{
                    ...
                    },
                        {
                            ...
                            rowspan: 2,
                            formatter: function (value, row, index) {
                                var e = '<a  class="btn btn-primary btn-sm ' + s_edit_h + '" href="#" mce_href="#" title="编辑" onclick="edit(\''+ row.id+ '\',\''+ row+ '\')"><i class="fa fa-edit "></i></a> ';
...
function edit(id,row) {
    if((row.weixiuPayer+row.jiaoyiPayer+row.fangbenPayer+row.qishuiPayer+row.daibanPayer)>0){
        layer.msg('已缴费，不能修改');
        return;
    }
    layer.open({
