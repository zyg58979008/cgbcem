							...
							/*	{
								   ...
								   formatter: function (value, row, index) {
								    ...
								    title : '项目类型',
																	formatter : function(value, row, index) {
																		if (value == '0') {
																			return '<span class="label label-default">判断型</span>';
																		} else if (value == '1') {
																			return '<span class="label label-success">文字型</span>';
																		}else if (value == '2') {
																			return '<span class="label label-info">数值型</span>';
																		}
																	}
