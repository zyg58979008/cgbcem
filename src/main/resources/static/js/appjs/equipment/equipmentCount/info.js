...
function add(orderId,equipmentId,i,n,b,c,m) {
	$.ajax({
		cache : true,
		type : "GET",
		url : "/equipment/equipmentCount/add?id="+orderId+"&equipmentIds="+equipmentId,
...
function del(orderId,equipmentId,i,state,n,b,c,m) {
	$.ajax({
		cache : true,
		type : "GET",
		url : "/equipment/equipmentCount/del?id="+orderId+"&equipmentIds="+equipmentId+"&state="+state,
		error : function(request) {
...
function save() {
	$.ajax({
		cache : true,
		type : "GET",
		url : "/equipment/equipmentCount/update/"+id,
		async : false,
		error : function(request) {
