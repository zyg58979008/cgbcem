        ...
        .bootstrapTable(
            {
                ...
                url: prefix + "/listQuery?delFlag=0", // 服务器数据的加载地址
                //	showRefresh : true,
                //	showToggle : true,
                //	showColumns : true,
                iconSize: 'outline',
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        align: 'center',
                        formatter: function (value, row, index) {
                            var e = '<a class="btn btn-info btn-sm ' + s_info_h + '" href="#" mce_href="#" title="盘库" onclick="info(\''
                                + row.id
...
function info(id) {
    index=layer.open({
        ...
        area: ['860px', '620px'],
        content: prefix + '/infoQuery/' + id// iframe的url
    });
    layer.full(index);
}