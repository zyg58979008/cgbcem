			...
			.bootstrapTable(
					{
						...
						url : prefix + "/equipmentInfoList", // 服务器数据的加载地址
					//	showRefresh : true,
					//	showToggle : true,
					//	showColumns : true,
						iconSize : 'outline',
						...
						columns : [
							...
							},
							{
								...
								align: 'center',
								formatter: function (value, row, index) {
									var e = '<a class="btn btn-primary btn-sm" href="#" mce_href="#" title="增加" onclick="add(\'' +row.id+ '\',\'' +row.name+ '\',\'' +row.brandname+ '\',\'' +row.brand+ '\',\'' +row.model+ '\',\'' +row.unitName+ '\',\'' +row.remarks+ '\')">' +
...
function add(id,name,brandname,brand,model,unitName,remarks) {
	parent.loadEquipment(id,name,brandname,brand,model,unitName,remarks);
