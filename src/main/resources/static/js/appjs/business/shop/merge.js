...
function save() {
    ...
    for(var i=0;i<num;i++){
        ...
        room.shopDOList.push(r);
    }
    jQuery.ajax({
        cache : false,
        type : "POST",
        url : "/business/shop/batchSave",
