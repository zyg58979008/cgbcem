					...
					//	showColumns : true,
						...
						columns : [
								...
								},
							{
								...
								formatter: function (value, row, index) {
									...
									align : 'center',
									formatter : function(value, row, index) {
										var e = '<a class="btn btn-primary btn-sm '+s_editGeneral_h+'" href="#" mce_href="#" title="编辑" onclick="edit(\''
												+ row.id
												+ '\')"><i class="fa fa-edit"></i></a> ';
										var d = '<a class="btn btn-danger btn-sm '+s_remove_h+'" href="#" title="删除"  mce_href="#" onclick="remove(\''
												+ row.orderId
												+ '\')"><i class="fa fa-remove"></i></a> ';
										var f = '<a class="btn btn-success btn-sm '+s_adnew_h+'" href="#" title="增加商铺"  mce_href="#" onclick="adnew(\''
												+ row.id
												+ '\')"><i class="fa fa-edit"></i></a> ';
										return e + d + f;
									}
						...
						onDblClickRow: function (item, $element) {
							...
							var perContent = layer.open({
								...
								area : [  '800px', '520px' ],
								content : prefix + '/activityDetailPay?orderId='+item.orderId // iframe的url
							});
...
/*function adnew(id) {
 ...
 shadeClose : false, // 点击遮罩关闭层
 area : [ '800px', '520px' ],
 content : prefix + '/adnew/'+id // iframe的url
 });
 }*/
function edit(id) {
	layer.open({
		...
		shadeClose : false, // 点击遮罩关闭层
		area : [ '800px', '520px' ],
		content : prefix + '/editGeneral/' + id // iframe的url
	});
}
function remove(id) {
